...
- [ ] Email de contacto — pendiente (Peach Estudio enviará el correcto; hoy oculto)
- [ ] Instagram — `[INSTAGRAM_PEACH_STUDIO]`
- [x] Ubicación — se muestra solo la zona (Palermo, CABA); dirección exacta oculta a pedido
